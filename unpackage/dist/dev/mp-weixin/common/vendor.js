...
exports.state = state;
var actions = {
  setUserData: function setUserData(_ref, data) {
  ...
  // 登录过期 重新登录
  reLogin: function reLogin(_ref2, info) {
...
var _default = {
   ...
   */
  showModal: function showModal(content, callback) {
    uni.showModal({
      title: '提示',
      content: content,
      showCancel: false,
...
exports.autoAddPoints = autoAddPoints;
// 自动添加省略号
function autoAddPoints(address) {
