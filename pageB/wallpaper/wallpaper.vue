          ...
          <view class="tn-flex tn-flex-col-center tn-flex-row-left">
            <view class="tn-color-white" style="width: 90vw;">
              ...
              <view class="tn-padding-right tn-padding-top-sm tn-text-ellipsis tn-text-sm">
                <text class="tn-padding-right-sm">眼里有光，世界将为你亮起！</text>
              </view>
            </view>
          </view>
        </view>
        <!-- <view class="justify-content-item tn-flex-row-center">
          <view class="logo-pic tn-shadow">
            <view class="logo-image">
              <view class="tn-shadow-blur" style="background-image:url('https://resource.tuniaokj.com/images/avatar/xiong/x12.jpg');width: 100rpx;height: 100rpx;background-size: cover;">
              </view>
            </view>
          </view>
        </view> -->
