      ...
      <view class="tn-text-justify">
        ...
        <view class="tn-margin">
          <view class="tn-flex tn-flex-row-between tn-flex-col-center">
            <view class="justify-content-item">
              <view class="tn-flex tn-flex-col-top tn-flex-row-left">
                <view class="logo-pic tn-margin-top-sm" style="background-image:url('https://resource.tuniaokj.com/images/avatar/xiong/x1.jpg')">
                  <view class="logo-image" >
                  </view>
                </view>
                <view class="tn-padding-right tn-color-black">
          ...
          <view class="tn-flex tn-flex-row-between tn-flex-col-center">
            ...
            <view class="justify-content-item">
              <view class="tn-flex tn-flex-col-top tn-flex-row-left">
                ...
                <view class="logo-pic tn-margin-top-sm" style="background-image:url('https://resource.tuniaokj.com/images/avatar/xiong/x12.jpg')">
                  <view class="logo-image" >
                  </view>
                </view>
          ...
          <view class="tn-flex tn-flex-row-center tn-flex-col-center">
            ...
            <view class="tn-flex tn-flex-row-center tn-flex-col-center tn-padding-right tn-padding-left-sm">
              ...
              <!-- <view class="avatar-all">
                <view class="tn-shadow-blur" style="background-image:url('https://resource.tuniaokj.com/images/avatar/xiong/x14.jpg');width: 60rpx;height: 60rpx;background-size: cover;">
                </view>
              </view> -->
            </view>
