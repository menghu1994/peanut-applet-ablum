<template>
  <view class="tn-safe-area-inset-bottom">
      ...
      <view class="tn-flex tn-flex-wrap tn-padding-bottom">
        <view class="" style="width: 100%;">
          <view class="img-shadow">
            <view class="image-picbook" style="background-image:url('https://resource.tuniaokj.com/images/avatar/xiong/x18.jpg');">
    ...
    <!-- <view class="slideshow">
      <view class="slideshow-image" style="background-image: url('https://resource.tuniaokj.com/images/avatar/xiong/x16.jpg')"></view>
    </view> -->
            ...
            <view class="">
              <view class="logo-pic tn-shadow">
                <view class="logo-image">
                  <view class="tn-shadow-blur" style="background-image:url('https://resource.tuniaokj.com/images/avatar/xiong/x6.jpg');width: 100rpx;height: 100rpx;background-size: cover;">
                  </view>
                </view>
              </view>
